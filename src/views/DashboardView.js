...
export default class DashboardView extends React.Component {
  ...
  addThermometerOp = () => {
    addThermometer(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  addGaugeOp = () => {
    addGauge(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  addIndicatorOp = () => {
    addIndicator(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  addIntensityOp = () => {
    addIntensity(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  addPMOp = () => {
    addPM(this.state.selectedDevice, this.state.selectedSensor).then((res) => {
      console.log(res.data);
      this.loadWidgets();
    });
  };
  addHumidityOp = () => {
    addHumidity(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  addElectricityOp = () => {
    addElectricity(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  addTvocOp = () => {
    addTvoc(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  addTemperatureOp = () => {
    addTemperature(this.state.selectedDevice, this.state.selectedSensor).then(
      (res) => {
        console.log(res.data);
        this.loadWidgets();
      }
  ...
  getDataCall = () => {
    this.state.widgets.forEach((widget) => {
      if (this.isChart(widget.type)) {
        getDaysData(widget.device, widget.sensor, widget.days).then((res) => {
          if (res.data.success) {
            let newWidgets = this.state.widgets.filter(
              (w) => w.id !== widget.id
            );
            if (widget.type === 'line') {
              ...
              uniqueData.forEach((uniq) => {
                let count = res.data.data.filter((d) => uniq === d.value)
                  .length;
        ...
        getLimitData(1, widget.device, widget.sensor).then((res) => {
          if (res.data.success) {
            let data =
              res.data.data.length > 0 ? res.data.data[0].value : 'No Data';
            widget.data = data;
            let newWidgets = this.state.widgets.filter(
              (w) => w.id !== widget.id
            );
              ...
              this.setState({
                ...
                ...(device.sensors[0]
                  ? {
                      ...
                      selectedSensor: device.sensors[0].id,
                    }
                  : {}),
              });
            }
  ...
  addChart = (type) => {
    this.setState({
      widgets: [...this.state.widgets, this.generateChart(type)],
    });
  };
  ...
  updateLayout = (layout) => {
    ...
    updateDashboard({ widgets: widgets }).then((res) => {
      if (res.data.success) {
  ...
  loadWidgets() {
    getWidgets().then((res) => {
      if (res.data.success) this.setState({ widgets: res.data.widgets });
      this.getDataCall();
    });
    this.getData();
  }
  ...
  render() {
    return (
      <div className={'dashboardMain'}>
        ...
        >
          {this.state.widgets.map((element) => (
            ...
            >
              ...
              {element.type === 'pm' && (
                <PM value={element.data * 8} height={element.layout.h * 30} />
              )}
              {element.type === 'humidity' && (
                <Humidity
                  value={element.data * 10}
                  height={element.layout.h * 30}
                />
              )}
              {element.type === 'electricity' && (
                <Electricity
                  value={element.data * 9}
                  height={element.layout.h * 30}
                />
              )}
              {element.type === 'tvoc' && (
              ...
              <div
                className='exitBtn2'
                onClick={() => this.deleteWidget(element._id)}
              >
                <FontAwesomeIcon
                  icon={faTimesCircle}
                  size='1x'
        ...
        <div
          onClick={() => this.setState({ modal: true, step: 1 })}
          className='addIcon'
        >
          <span>+</span>
        </div>
          ...
          <div className={`ModalContent`}>
            ...
            {this.state.step === 1 ? (
              [
                ...
                <div className='WidgetContainer'>
                  <div
                    ...
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'bar' });
                    }}
                  >
                    <img src={barIcon} />
                    <h3>Bar Graph</h3>
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'pie' });
                    }}
                  >
                    <img src={donutIcon} />
                    <h3>Pie Chart</h3>
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'radar' });
                    }}
                  >
                    <img src={radarIcon} />
                    <h3>Radar Graph</h3>
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'line' });
                    }}
                  >
                    <img src={lineIcon} />
                    <h3>Line Graph</h3>
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'area' });
                    }}
                  >
                    <img src={areaIcon} />
                    <h3>Area Graph</h3>
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'thermometer' });
                    }}
                  >
                    <img src={thermometerIcon} />
                    <h3>Thermometer</h3>
                    <p>
                      A Thermometer widget to show different distinction of
                      groups
                    </p>
                  </div>
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'gauge' });
                    }}
                  >
                    <img src={gaugeIcon} />
                    <h3>Gauge</h3>
                    <p>
                      A Gauge widget to show different distinction of groups
                    </p>
                  </div>
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'indicator' });
                    }}
                  >
                    <img src={indicatorIcon} />
                    <h3>Indicator</h3>
                    <p>
                      An Indicator widget to show different distinction of
                      groups
                    </p>
                  </div>
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'intensity' });
                    }}
                  >
                    <img src={intensityIcon} />
                    <h3>Intensity Chart</h3>
                    <p>
                      An Intensity widget to show different distinction of
                      groups
                    </p>
                  </div>
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'pm' });
                    }}
                  >
                    <img src={pmIcon} />
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'humidity' });
                    }}
                  >
                    <img src={humidityIcon} />
                    <h3>Humidity Chart</h3>
                    <p>
                      A Humidity widget to show different distinction of groups
                    </p>
                  </div>
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'electricity' });
                    }}
                  >
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'tvoc' });
                    }}
                  >
                    <img src={tvocIcon} />
                    <h3>VOC Chart</h3>
                  ...
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'temperature' });
                    }}
                  >
                    <img src={temperatureIcon} />
                    <h3>Temperature Chart</h3>
                    <p>
                      A Temperature widget to show different distinction of
                      groups
                    </p>
                  </div>
                  <div
                    className='widgetOption'
                    onClick={() => {
                      this.setState({ step: 2, selectedWidget: 'scatter' });
                    }}
                  >
                    <img src={scatterIcon} />
                    <h3>Scatter Graph</h3>
                    <p>
                      A scatter graph to show different distinction of groups
                    </p>
                  </div>
                </div>,
              ]
              ...
              <div className='widgetSelectionContainer'>
                <img
                  src={nameToImg[this.state.selectedWidget]}
                  className='widgetSelectionImg'
                />
                <div className='widgetSelectionRight'>
                  ...
                  <div className='widgetSelectionForm'>
                    ...
                    <select
                      ...
                      onChange={(value) =>
                        this.setState({ selectedDevice: value.target.value })
                      }
                    >
                    ...
                    >
                      {this.state.devices.map((device) => (
                        <option value={device.id}>Select Data</option>
                      ))}
                    </select> */}
                    {this.state.selectedDevice
                      ? [
                          ...
                          <select
                            ...
                            onChange={(value) =>
                              this.setState({
                                selectedSensor: value.target.value,
                              })
                            }
                          >
                            {this.state.devices
                              .find((d) => d.id === this.state.selectedDevice)
                              .sensors.map((sensor) => (
                      ...
                      : ''}
                    {this.isChart(this.state.selectedWidget)
                      ? [
                          <small>Enter Days for range of data</small>,
                          <FormField
                            onChange={(value) =>
                              this.setState({ days: value.target.value })
                            }
                    ...
                    <FormButton
                      ...
                      color='orange'
                      onClick={() => {
                        this.state.selectedWidget !== 'thermometer'
                          ? this.addChartOp()
                          : this.addThermometerOp();
