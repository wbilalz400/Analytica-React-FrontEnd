...
export default class extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          'HomeBody ' + (this.state.sideBarCollapse ? 'collapsed' : '')
        }
      >
        <div className='sideBar'>
          ...
          <div className='Menus'>
            ...
            <div
              onClick={() => (window.location.href = '/home/devices')}
              className='MenuItem'
            >
            ...
            <div
              onClick={() => (window.location.href = '/home/actions')}
              className='MenuItem'
            >
            ...
            <div
              onClick={() => (window.location.href = '/home/selectdata')}
              className='MenuItem'
            >
            ...
            <div
              onClick={(e) => this.collapse('collapseProfile')}
              className='MenuItem'
            >
              ...
              <FontAwesomeIcon
                ...
                rotation={this.state.collapseProfile ? 180 : 0}
              ></FontAwesomeIcon>
            </div>
            <Collapse isOpened={this.state.collapseProfile}>
              <div
                onClick={() => (window.location.href = '/home/editprofile')}
                className='ChildItem'
              >
        ...
        <div className='main'>
          ...
          <div
            ...
            className={'content ' + (this.state.loading ? '' : '')}
          >
            <Router>
              <Switch>
                ...
                <Route
                  ...
                  render={(props) => (
                    <MyProfileView user={this.state.user} {...props} />
                  )}
                />
                <Route path='/home/actions' component={Actions} />
                <Route path='/home/selectdata' component={SelectData} />
